...
export default function SecretarySignatureUpload() {
  ...
  const uploadSignature = async (file: File) => {
    try {
      ...
      const fileName = `secretary-signature-${Date.now()}.${fileExt}`;
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Upload your digital signature. This will be automatically added to meeting minutes when you create them.
          </p>
      ...
      <Card className="bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800">
        <CardContent className="pt-6">
          ...
          <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
            ...
            <li>Your signature is automatically added to meeting minutes you create</li>
            <li>The signature will appear on all minutes you submit</li>
